...
// section calls for has landed in this checkout (note: at `data/raw/archive/ai-requirements-index.csv`,
// NOT at the `data/raw/AI-Skills-in-Job-Requirements/` path the SPEC and dataset-evaluations.md
// originally cited — the extracted directory landed under a different name this time; flagged,
// not reconciled). Extracted 2026-07-28 via:
//   grep -E '^2026-07-22,(ai|data|devops|engineering|product|security),(entry|mid|senior),any_ai,' \
//     data/raw/archive/ai-requirements-index.csv
...
export const SENIORITY_GRADIENT: Record<DatamataCategory, SeniorityGradient> = {
  // REAL — data/raw/archive/ai-requirements-index.csv @ 2026-07-22, tier=any_ai.
  ...
  // REAL — data/raw/archive/ai-requirements-index.csv @ 2026-07-22, tier=any_ai. entry_pct (0.0)
  ...
  // REAL — data/raw/archive/ai-requirements-index.csv @ 2026-07-22, tier=any_ai. Matches
